...
import { z } from 'zod';
import { User, Building2, LogOut, ArrowLeft, Trophy } from 'lucide-react';
import { useAuthStore } from '../../store/useAuthStore';
import { Button } from '@/components/ui/button';
import { Input } from '@/components/ui/input';
import { Label } from '@/components/ui/label';

const registrarSettingsSchema = z.object({
...
type RegistrarSettingsValues = z.infer<typeof registrarSettingsSchema>;

export default function RegistrarProfileSettingsPage() {
  ...
  } = useForm<RegistrarSettingsValues>({ resolver: zodResolver(registrarSettingsSchema) });
  ...
  const onSubmit = async (values: RegistrarSettingsValues) => {
    await updateProfile({
      ...
      <main className="max-w-3xl mx-auto px-6 py-8">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <section className="bg-white border border-neutral-200 rounded-xl p-6">
            ...
            <p className="text-sm text-neutral-500 mb-4">Your department assignment and contact details</p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="department" placeholder="Registrar's Office" {...register('department')} />
                  {errors.department && (
                ...
                <div>
                  ...
                  <Input id="position" placeholder="Registrar Officer" {...register('position')} />
                  {errors.position && (
