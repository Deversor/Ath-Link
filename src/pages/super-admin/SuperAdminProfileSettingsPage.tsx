...
export default function SuperAdminProfileSettingsPage() {
  ...
  } = useForm<AdminSettingsValues>({ resolver: zodResolver(adminSettingsSchema) });
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input id="department" placeholder="Sports Office, Athletics Dept" {...register('department')} />
                  {errors.department && (
                ...
                <div>
                  ...
                  <Input id="position" placeholder="Sports Coordinator" {...register('position')} />
                  {errors.position && (
